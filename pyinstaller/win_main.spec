...
casroot_paths = [(casroot, os.path.join('marvin', 'casroot'))]
...
data_files = [(os.path.join('test', 'data'),
               os.path.join('marvin', 'test', 'data')),
              (os.path.join('..', 'doc'),
               os.path.join('marvin', 'doc')),
             ]
...
a = Analysis(['__main__.py'],
             pathex=['C:\\Users\\waterbug\\clones\\marvin\\marvin'],
             binaries=[('C:\\Users\\waterbug\\miniconda3'
                        '\\Library\\bin\\TKOpenGl.dll',
                        'bin')],
             datas=data_files,
